...
def compare_states(states_list, compare_cats):
    ...
    plot = mydf[compare_cats].iloc[states_list].plot(kind="bar", figsize=(30, 8),
                                                     title="Category Frequencies Across Selected States", x="states")
...
choices = ["Heart Disease", "Cancer", "Chronic Lower Respiratory Diseases",
           ...
           "Influence and Pnemonia", "Kidney Disease", "Mental Illness",
           "Chronic Liver Disease"]
wanted_fig = compare_states(rng.choice(usstates, size=rng.integers(1, high=50), replace=False),
                            rng.choice(choices, size=10, replace=False))
chosenk = rng.integers(1, high=11)
chosenstate = rng.choice(usstates)
print("The top k = " + str(chosenk) + " most prevalent categories in chosen state = " + str(chosenstate) + " are: ")
print(k_most_prevalent(chosenk, chosenstate))
print("")
chosenk = rng.integers(1, high=50)
chosenstate = rng.choice(usstates)
print("The top k = " + str(chosenk) + " most similar states for chosen state = " + str(chosenstate) + " are: ")
print(top_k_similar_states(chosenk, chosenstate))
print("")
